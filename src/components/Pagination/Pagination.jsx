...
export const Pagination = ({ pagination }) => {
	...
	const prevPageUrl = prevPageNumber > 0 ? createPageUrl(prevPageNumber) : ''; const nextPageUrl = nextPageNumber <= totalPages ? createPageUrl(nextPageNumber) : '';
	...
	return (
		<div className={s.pagination}>
			<div className={s.bar}>
				<div className={s.barWidth} style={{width:`calc(${width < totalProducts ? width : totalProducts} / ${totalProducts} * 100%)`}}></div>
